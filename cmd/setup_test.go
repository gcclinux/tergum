...
func TestInteractiveSetupRequiresPassphrase(t *testing.T) {
	...
	// role=client, clientIPchoice=1, serverAddress=192.168.1.100, natMode=n, generateCerts=n, passphrase=
...
func TestInteractiveSetupShortPassphrase(t *testing.T) {
	...
	// role=client, clientIPchoice=1, serverAddress=192.168.1.100, natMode=n, generateCerts=n, passphrase=short
	input := strings.NewReader("client\n1\n192.168.1.100\nn\nn\nshort\n")
	var output bytes.Buffer
...
func TestInteractiveSetupFullFlow(t *testing.T) {
	...
	// role=client, clientIPchoice=1, server_address=192.168.1.100, natMode=n, generate_certs=n, passphrase=mysecretpass123
...
func TestInteractiveSetupExistingConfig(t *testing.T) {
	...
	// inputs: role, clientIPchoice, server, natMode, certs, overwrite=n, passphrase=mysecretpass123
	inputs2 := "client\n1\n192.168.1.100\nn\nn\nn\nmysecretpass123\n\ny\ny\n\nn\n\n\n"
	...
	// inputs: role, clientIPchoice, server, natMode, certs, overwrite=n, passphrase=wrongpass, retry=n
	inputs3 := "client\n1\n192.168.1.100\nn\nn\nn\nwrongpass\nn\n"
